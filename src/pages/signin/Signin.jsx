                ...
                <Box sx={{display : "flex",alignItems: "center",justifyContent: "center" , height:"90vh" }}>
                    <Box sx={{ flex: 1, display: "flex",flexDirection : "column",textAlign: "center",alignItems: "center",justifyContent: "space-between",height: "90vh",
                        "@media (max-width:950px)": {
                            ...
                            <Box  sx={{ paddingBottom: "10px" }}>
                                <Typography sx={{color : "#4B0082",fontFamily: "Epilogue", fontWeight : "400"}}>Powered by <span style={{fontWeight: "800"}}> Shashankan </span></Typography>
                            </Box>   
                    ...
                    <Box className="siContainer" sx={{ flex: 1,display: "flex",flexDirection: "column",alignItems: "center",justifyContent: "center",}}>
                        ...
                        <Box sx={{ width : "70%", "@media (max-width:550px)": {
                            ...
                            <TextField sx={{marginBottom : "20px"}} value={email} onChange={(e) => setEmail(e.target.value)} InputProps={{
                                sx: {
                                    borderRadius: "25px", 
                            ...
                            <TextField sx={{marginBottom : "20px"}} value={password} onChange={(e) => setPassword(e.target.value)} InputProps={{endAdornment: (
                        ...
                        <Box sx={{padding : "20px","@media (max-width:400px)": {
                                    fontSize : "14px",
                                },}}>
                        ...
                        <Box sx={{textAlign: "center",justifyItems : "center"}}>
                            <Button onClick={handleSignIn} sx={{ textTransform : "capitalize", fontFamily : "Epilogue" , backgroundColor : "rgba(227, 235, 255, 1)", color : "#0D1B4C", width:"150px", height:"50px", borderRadius: " 30px",fontSize:"15px","@media (max-width:400px)": {
                                    fontSize : "14px",
                                    width : "100px",
                                    height : "30px"
                                },}}>Sign in</Button>
                        </Box>
                        <Box sx={{textAlign: "center",justifyItems : "center", padding : "20px","@media (max-width:400px)": {
                                    fontSize : "14px",
                                },}}>
                            <Typography sx={{color : "rgba(227, 235, 255, 1)"}}> or Signin with</Typography>
                            <Box  sx={{display: "flex", textAlign: "center", gap:"8px", padding : "20px"}}>
                        ...
                        <Box sx={{textAlign: "center",justifyItems : "center", padding : "20px","@media (max-width:400px)": {
                            ...
                            <Typography sx={{color : "rgba(227, 235, 255, 1)"}}> don't have an account? <Link style={{ color : "rgba(227, 235, 255, 1)", textDecoration: "none", cursor:"pointer"}} to="/register">Sign up</Link></Typography>
                        </Box>
                    </Box>
                </Box>
